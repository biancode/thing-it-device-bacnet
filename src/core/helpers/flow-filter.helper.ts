...
export class FlowFilter {
     ...
     */
    static isServiceType (serviceType: BACnet.Enums.ServiceType): BACnetFlowFilter {
     ...
     * @return {BACnetFlowFilter}
     */
    static isServiceChoice (serviceChoice: any): BACnetFlowFilter {
        return (resp: Interfaces.FlowManager.Response): boolean => {
     ...
     * @return {BACnetFlowFilter}
     */
    static isBACnetObject (objId: BACnet.Types.BACnetObjectId): BACnetFlowFilter {
        return (resp: Interfaces.FlowManager.Response): boolean => {
     ...
     * @return {BACnetFlowFilter}
     */
    static isBACnetProperty (propId: BACnet.Enums.PropertyId): BACnetFlowFilter {
        return (resp: Interfaces.FlowManager.Response): boolean => {
     ...
     * @return {BACnetFlowFilter}
     */
    static isBACnetVendorId (vendorId: number): BACnetFlowFilter {
        return (resp: Interfaces.FlowManager.Response): boolean => {
     ...
     * @return {BACnetFlowFilter}
     */
    static isBACnetIPAddress (ipAddress: string): BACnetFlowFilter {
        return (resp: Interfaces.FlowManager.Response): boolean => {
