 ...
 * @return {void}
 */
BACnetServiceManager.prototype.initManager = function (config, priority, deviceId) {
    var _this = this;
    this.config = config;
    this.deviceId = deviceId;
    this.config.priority = !_.isNil(priority) ? priority : 16;
    this.server = redux.store.getState(['bacnet', this.deviceId,  'bacnetServer']);
...
BACnetServiceManager.prototype.tickCOVTimer = function (covTimerConfig) {
    ...
    BACnetAction.tickCOVTimer(this.deviceId, covTimer);
};
/**
